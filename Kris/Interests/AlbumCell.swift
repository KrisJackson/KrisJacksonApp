...
//  Kris
//
//  Created by Kristopher Jackson on 3/31/20.
...
class AlbumCell: UICollectionViewCell {
    ...
    let moreButton: UIButton = {
        ...
        button.setTitle("Listen on Spotify", for: .normal)
        button.layer.cornerRadius = 8
        button.layer.masksToBounds = true
        button.setTitleColor(ColorTheme.spotifyGreen, for: .normal)
        button.backgroundColor = ColorTheme.lightSpotifyGreen
    ...
    override init(frame: CGRect) {
        ...
        imageShadow.widthAnchor.constraint(equalToConstant: height).isActive = true
